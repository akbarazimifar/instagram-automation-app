...
public class PostInfoRequest extends IGGetRequest<PostInfoResponse> {
    ...
    @Override
    public PostInfoResponse parseResponse(kotlin.Pair<Response, String> response) {

        PostInfoResponse igResponse = null;
        try {
    ...
    public PostInfoRequest(String shortcode) {
    ...
    @Override
    public Class<PostInfoResponse> getResponseType() {
        return PostInfoResponse.class;
    }
