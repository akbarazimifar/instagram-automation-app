    ...
    public static String getRemixPayload(MediaConfigureReelRemixRequest.MediaConfigurePayload payload){
        ...
        try {
            String process = template
                    .replace("${DUR0MS}", "27800")
                    .replace("${DUR1MS}", "529")
                    .replace("${DIM_H}", "1280")
                    .replace("${DIM_W}", "720")
                    .replace("${DURSEC}", "28.329");
